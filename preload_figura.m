function preload_figura(X1, Y1, X2, Y2, X3, Y3, X4, Y4)
...
%  Auto-generated by MATLAB on 15-Apr-2021 17:39:00
...
% Create plot
plot(X1,Y1,'DisplayName','R_m = 0.1','LineWidth',2.5);

% Create plot
plot(X2,Y2,'DisplayName','R_m = 0.08','LineWidth',2.5);

% Create plot
plot(X3,Y3,'DisplayName','R_m = 0.04','LineWidth',2.5);
...
set(legend1,...
    'Position',[0.146634196198865 0.680558041719764 0.344927528155023 0.224203863042141],...
    'FontSize',11);
